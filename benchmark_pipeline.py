...
def main():
    ...
    ENV_CSV_PATH = FOLDER_PATH + "environment_250_with_llm_answer.csv"
    HEALTH_CSV_PATH = FOLDER_PATH + "health_250_with_llm_answer.csv"
    ...
    # ========= CSV 저장 =========
    env_output_path = OUTPUT_PATH + "environment_250_scored.csv"
    ...
    health_output_path = OUTPUT_PATH + "health_250_scored.csv"
